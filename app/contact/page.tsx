...
import { ContactViewportLock } from './contact-viewport-lock'
import { KnownContactDetails } from './known-contact-details'
...
export default function ContactPage() {
  return (
    <>
      <ContactViewportLock />
      <section className="contact-stage page-shell relative isolate flex h-dvh w-full items-center justify-center overflow-hidden pb-8 pt-24 sm:pb-10 sm:pt-28">
