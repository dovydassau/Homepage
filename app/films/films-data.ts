...
const dopEntries: DopEntry[] = [
  ...
  // },
  {
    ...
    extraCredits: [
      { label: 'Sound', value: 'Patrick Rosseau' },
      { label: 'Editor', value: 'Kai Takeuchi' },
      { label: 'Colourist', value: 'Adam Bastin' },
      { label: 'AD', value: 'Vincent Janssen' },
      { label: 'HMU & Costumes', value: 'Inna Kozak'},
      { label: 'PA', value: 'Silke van der Burgt'},
      { label: 'Runner', value: 'Otis Wishart'},
      { label: 'Runner', value: 'Bree Shaw'},
      { label: 'Runner', value: 'Andreas Finke'},
    ],
    extraContent: [
      {
        title: 'BTS',
